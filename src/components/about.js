    ...
    return (
      <div>
        <div className="profile-picture">
          ...
          <img src={TG_photo} alt="Tamira Gunzburg-Chibua" height="300px;" />
        </div>
        ...
        <div className="contact-info">
          ...
          <my-email data-user="t.gunz.chi" data-domain="gmail.com">
            @
          </my-email>
          ...
          <div className="social-links">
            ...
            <a
              href="https://www.linkedin.com/in/tamira-gunzburg-chibua/"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div className="intro">
          ...
          <p>
            ...
            intensive bootcamp in software engineering. I have been working as a
            software engineer ever since, happy as a clam. I'm always on the
            lookout to keep learning and give back.
          </p>
        </div>
      </div>
    );
